...
const courseData = [
  ...
  },
  {
    ...
    instructor: "Raj Heda",
    what_you_learn:
      "<p>Designed for developers, this course will hone your agile skills. Through both formal training  and an assessment of your technical skills, you’ll obtain a working knowledge of Scrum and  Agile principles. In addition, you’ll learn the engineering skills used by Agile developers. The  course instructs developers in the tools and techniques for delivering code in an iterative process,  key to Agile software development </p> <p>Upon completing this course, you will have mastered the skill set required to engage in an Agile  development environment. You’ll become proficient with the tools and techniques used to  contribute to an agile team. Certification as a Certified Scrum Developer demonstrates your  commitment to the Agile principles. </p> <p>When you complete this course and gain the Certified SAFe® Scrum Master certificate, this certification will demonstrate to companies that you are equipped and ready to lead Agile teams in a SAFe environment, and that your servant leadership and coaching skills will bring tremendous growth and value to their organizations.</p> <p>Unlike any other training program, we offer the following bonuses:</p> <ul> <li>The highest passing rates: The Certified Scrum Developer (CSD) certification exam is  rigorous, but you will be prepared. Nearly 100% of our graduates pass the exam on their  very first attempt. In the unlikely event that you would need to retake the exam, a second  trial is free and additional examinations are discounted.</li> <li>Free follow-up access to your course materials for one year.</li> <li>25% discount on future course fees. Save on courses as you sail through the certification process.</li> <li>Anytime availability: Your course are available over the Internet 7 days a week and 24 hours a day. Study at any day and time you want. Once you are ready, simply sign up to take the certification exam!</li> </ul> <p>Prerequisites: Previous experience as a software developer in an IT organization highly desired,  whether from actual industry experience or theory.</p>",
    price: 3000,
    time: "2:20 PM",
    month: "june",
    instructor_bio:
  ...
  },
  {
    ...
    instructor: "Raj Heda",
    what_you_learn:
      "<p>In an Agile development environment, a program increment (PI) is a timebox during which the  Agile Release Train incrementally delivers value through deploying new systems and  software. It is the summation of a set of sprints, and usually lasts 8-12 weeks. The PI is the final  artifact of the scrum framework, and represents a usable solution</p> <p>This workshop guides participants through the process of defining the program increment,  guiding its development cycle, and realizing its functionality through deployment. Practicing  Scrum without a program increment is merely wasted effort and a lost opportunity. This  customized workshop shows your team how to successfully define and deliver the PI.</p> <p>Everyone in the Agile team will benefit from this workshop. You’ll learn how to set realistic  goals for the program increment, how to ensure sprints will deliver the PI, and how to utilize  program increments to continuously improve the outcomes of your agile development process. </p> <p>Unlike any other training program, we offer the following bonuses: </p> <ul> <li>Free follow-up access to your course materials for one year. </li> <li>25% discount on future course fees. Save on courses as you sail through the certification  process. </li> <li>Anytime availability: Your course are available over the Internet 7 days a week and 24  hours a day. Study at any day and time you want. Once you are ready, simply sign up to  take the certification exam! </li></ul> </p>Prerequisites: Previous experience in an IT organization highly desired, whether from actual  industry experience or theory. </p>",
    price: 1500,
    time: "9:55 AM",
    month: "june",
    instructor_bio:
  ...
  {
    course_name: "Inspect & Adapt (customized offering) ",
