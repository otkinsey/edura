...
Scenario: To validate header section 
	...
	And I should see Assessment Training links 
...
Scenario: To validate navigation to courses page
	Given I am on edura homepage
	When I click on training link
	And I click on courses link in the dropdown
	Then I should be navigated to Courses page

Scenario: To navigate to Upcoming courses page
		Given I am on edura homepage
		When I click on training link
