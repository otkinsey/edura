...
public class HomepageStepDefinitions {
	...
	@Then("^I should see Assessment Training links$")
	...
	public void i_should_see_view_courses_link() throws Throwable{
		Assert.assertTrue("View Courses Button is not displayed", home.courseCalendarButton.isDisplayed());
	}
	...
	public void i_should_see_dropdown_menu() throws Throwable{
		Assert.assertTrue("Courses link is not displayed",home.CoursesLink.isDisplayed());
		Assert.assertTrue("Upcoming Courses link is not displayed",home.upcomingCoursesLink.isDisplayed());
	}
	...
	@When("^I click on Upcoming courses$")
	public void i_click_on_Upcoming_courses() throws Throwable{
		home.clickUpcomingCoursesLink();
	}
	
	@When("^I click on courses link in the dropdown$")
	public void i_click_on_Courses_link_in_the_dropdown() throws Throwable{
